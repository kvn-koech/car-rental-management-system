...
class Car(db.Model):
    ...
    status = db.Column(db.Enum(CarStatus), default=CarStatus.AVAILABLE, index=True)
...
class Booking(db.Model):
    ...
    status = db.Column(db.Enum(BookingStatus), default=BookingStatus.PENDING, index=True)
