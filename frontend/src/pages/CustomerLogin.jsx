  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-slate-900 transition-colors duration-300 pt-16">
      <div className="max-w-md w-full bg-white dark:bg-slate-800 p-8 rounded-xl shadow-lg border border-gray-100 dark:border-slate-700">
        <h2 className="text-2xl font-bold mb-6 text-center text-secondary dark:text-white">Welcome Back</h2>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="relative">
            ...
            <button
              type="button"
              className="absolute right-3 top-9 text-gray-500 dark:text-gray-400 hover:text-primary focus:outline-none"
        ...
        <p className="mt-4 text-center text-sm text-gray-600 dark:text-gray-400">
          ...
          <Link to="/signup" className="text-primary dark:text-blue-400 hover:underline">
            Sign up
          </Link>
        </p>
      </div>
